    ...
    return (
      <div className="ui inline dropdown right face">                  
        <Avatar 
          ...
          round={true} 
          size={32} 
          src={(this.state.currentFace.faceImage) ? this.state.currentFace.faceImage : user.image} 
        ...
        <div className="menu left">
          <div className="item" onClick={() => {this.setType('user', user)}}>
            <Avatar color={`#46978c`} round={true} size={20} src={user.image} name={user.fullName} />
            ...
            this.state.faces.map((item, i) => {
              return (
                <div onClick={() => {this.setType('blog', item)}} className="item" key={i}>
                  <Avatar color={`#46978c`} round={true} size={20} src={item.image} name={item.title} />
