      ...
      var m,
          ...
          D.off(E), m.off(E), v.off(E), m.off(E);
            ...
            if (e.isPlainObject(t)) {
              var n,
                  o = (0, _keys2.default)(t),
                  a = o.length > 0 ? t[o[0]].identifier !== i && t[o[0]].rules !== i : !1;a ? (x = e.extend(!0, {}, e.fn.form.settings, u), C = e.extend({}, e.fn.form.settings.defaults, t), O.error(x.error.oldSyntax, q), O.verbose("Extending settings from legacy parameters", C, x)) : (t.fields && (n = (0, _keys2.default)(t.fields), ("string" == typeof t.fields[n[0]] || e.isArray(t.fields[n[0]])) && e.each(t.fields, function (n, i) {
    ...
    var o,
      ...
      var d,
          ...
          m.verbose("Toggling dimmer visibility", d), m.is.dimmed() ? m.hide() : m.show();
            ...
            return "object" == (0, _typeof3.default)(g.duration) ? m.is.active() ? g.duration.hide : g.duration.show : g.duration;
    ...
    var a,
      ...
      var r,
          ...
          C.has.popup() && !w.popup && (C.debug("Removing popup", r), r.remove(), r = i, w.onRemove.call(r, L));
            ...
            return (typeof SVGGraphicsElement === "undefined" ? "undefined" : (0, _typeof3.default)(SVGGraphicsElement)) === i;
          } }, animate: { show: function show(t) {
        ...
        var n = "",
            o = e.fn.popup.settings.templates.escape;return (typeof t === "undefined" ? "undefined" : (0, _typeof3.default)(t)) !== i && ((0, _typeof3.default)(t.title) !== i && t.title && (t.title = o(t.title), n += '<div class="header">' + t.title + "</div>"), (0, _typeof3.default)(t.content) !== i && t.content && (t.content = o(t.content), n += '<div class="content">' + t.content + "</div>")), n;
      } } };
}(jQuery, window, document), function (e, t, n, i) {
  "use strict";
    ...
    var a,
      ...
      var m,
          ...
          var n = t.length,
            ...
            var t = S.data(h.cache);return g.cache ? (m.verbose("Checking cache for generated html for query", e), "object" == (typeof t === "undefined" ? "undefined" : (0, _typeof3.default)(t)) && t[e] !== i ? t[e] : !1) : !1;
    ...
    var o,
      ...
      var a,
          ...
          h.verbose("Destroying previous module for", P), T.removeData(S).off(k);
            ...
            return o && "" === o ? void h.debug("Response empty, not caching", o) : t.Storage === i ? void h.error(C.noStorage) : (e.isPlainObject(o) && (o = (0, _stringify2.default)(o)), sessionStorage.setItem(n, o), void h.verbose("Storing cached response for url", n, o));
          } }, query: function query() {
